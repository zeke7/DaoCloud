// API 请求根路径
// var root = "http://127.0.0.1:8000"; //本地
var root = "http://112.74.55.61:8081"; //服务器
...
// API url路径
var urls = {
	login: `${root}/login`, //系统：登录授权
	signUp: `${root}/signup`, //注册
	modifyPassword: `${root}/modifyPassword`, //修改密码
}
