...
// 全局路由
const globalRoutes = [
  {path: '/school-add-or-update', component: _import('modules/student/school-add-or-update'), name: 'login', meta: {title: '登录'}},
  {path: '/classList', component: _import('modules/student/classList'), name: 'login', meta: {title: '登录'}},
  {path: '/home', component: _import('common/home'), name: 'login', meta: {title: '登录'}},
...
const mainRoutes = {
  ...
  children: [
    ...
    {path: '/building', component: _import('common/building'), name: 'building', meta: {title: '建设中'}},
    {
      ...
      component: _import('modules/student/classList'),
      name: 'classList',
      meta: {title: '班课列表', isTab: true}
    },
    {
      path: '/dictionary-dictionarylist',
      component: _import('modules/dictionary/dictionarylist'),
      name: 'dictionarylist',
      meta: {title: '字典详情', isTab: true}
    }
  ]
